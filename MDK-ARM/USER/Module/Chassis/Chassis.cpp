...
//void Class_Chassis::Set_Velocity_Slow(SpeedTypeDef __Velocity)
//{
//		SpeedTypeDef __Velocity_Change , __Velocity_Set_Temp;
//		__Velocity_Change.X = (__Velocity.X - Velocity.X)/20;
//		__Velocity_Change.Y = (__Velocity.Y - Velocity.Y)/20;
//		__Velocity_Change.Omega = (__Velocity.Omega - Velocity.Omega)/20;
//		__Velocity_Set_Temp = Velocity;
//		for(int i=0;i<20;i++)
//		{
//			__Velocity_Set_Temp.X = __Velocity_Set_Temp.X + __Velocity_Change.X;
//			__Velocity_Set_Temp.Y = __Velocity_Set_Temp.Y + __Velocity_Change.Y;
//			__Velocity_Set_Temp.Omega = __Velocity_Set_Temp.Omega + __Velocity_Change.Omega;
//			Velocity = __Velocity_Set_Temp;
//			HAL_Delay(50);
//		}
//}
